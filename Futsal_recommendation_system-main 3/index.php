        ...
        <div class="user-info">
            ...
            <div>
                <?php if ($_SESSION['username'] === 'admin'): ?>
                    <a href="admin_bookings.php" class="logout-btn">🔧 Admin Panel</a>
                <?php endif; ?>
                <a href="my_bookings.php" class="logout-btn">📅 My Bookings</a>
                ...
                <?php foreach ($results as $index => $f): ?>
                    <div class="result-card">
                        <div class="card-content">
                            ...
                            <a href="booking.php?futsal=<?= urlencode($f['name']) ?>" class="book-btn">Book Now</a>
                        </div>
        ...
        ${results.map((f, index) => `
            <div class="result-card">
                <div class="card-content">
                    ...
                    <a href="booking.php?futsal=${encodeURIComponent(f.name)}" class="book-btn">Book Now</a>
                </div>
